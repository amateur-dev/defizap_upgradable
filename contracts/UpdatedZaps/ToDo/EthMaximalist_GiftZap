...
contract ETHMaximalist is Ownable, ReentrancyGuard {
    ...
    function LetsInvest(address _gifteeAddress) stopInEmergency payable public returns (bool) {
        ...
        Invest2Fulcrum1xShortBTCContract.LetsInvest2Fulcrum1xShortBTC.value(investAmt2ShortBTC)(_gifteeAddress);
        Invest2FulcrumContract.LetsInvest2Fulcrum.value(investAmt2c1xLongETH)(_gifteeAddress);
