...
contract LLP_ETH_LinkZap is Initializable {
    ...
    function LetsInvest(address payable _towhomtoIssueAddress, uint _2XLongETHAllocation, address _InvesteeTokenAddress, uint _slippage, bool _residualInToken) public payable returns(uint) {
        ...
        Invest2FulcrumAddress.LetsInvest.value(ETH2xLongPortion)(ETH2x_ADDRESS, _InvesteeTokenAddress, _slippage,  _towhomtoIssueAddress);
    ...
    function() external payable {
        if (msg.sender != owner) {
            LetsInvest(msg.sender, 34, 0x514910771AF9Ca656af840dff83E8264EcF986CA, 5, false);}
    }
