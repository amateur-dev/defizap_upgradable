...
// File: browser/Balancer_Unipool_Bridge_Zap_v1.sol

// Copyright (C) 2020 defizap, dipeshsukhani, nodarjanashia, suhailg, apoorvlathey
...
// interface
interface IWethToken_Balancer_Unipool_Bridge_Zap_V1 {
...
interface IBFactory_Balancer_Unipool_Bridge_Zap_V1 {
    function isBPool(address b) external view returns (bool);
}


interface IBPool_Balancer_Unipool_Bridge_Zap_V1 {
...
interface IuniswapFactory_Balancer_Unipool_Bridge_Zap_V1 {
...
interface Iuniswap_Balancer_Unipool_Bridge_Zap_V1 {
...
contract Balancer_Unipool_Bridge_Zap_V1 is ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    bool private stopped = false;
    uint16 public goodwill;
    address public dzgoodwillAddress;

    IuniswapFactory_Balancer_Unipool_Bridge_Zap_V1 public UniSwapFactoryAddress = IuniswapFactory_Balancer_Unipool_Bridge_Zap_V1(
        0xc0a47dFe034B400B47bDaD5FecDa2621de6c4d95
    );
    IBFactory_Balancer_Unipool_Bridge_Zap_V1 BalancerFactory = IBFactory_Balancer_Unipool_Bridge_Zap_V1(
    ...
    function LetsBridge(
        ...
        uint256 goodwillPortion = SafeMath.div(
            SafeMath.mul(_IncomingBPT, goodwill),
            10000
        );
        
        //transfer remaining to this contract
        require(
        ...
        // IF ToToken in Pool
        if (
            IBPool_Balancer_Unipool_Bridge_Zap_V1(_FromBalancerPoolAddress)
                .isBound(_ToTokenContractAddress)
        ) {
            // Zapout from Pool to ToToken
            uint256 returnedTokens = _exitBalancer(
                _FromBalancerPoolAddress,
                _ToTokenContractAddress,
                SafeMath.sub(_IncomingBPT, goodwillPortion)
            );
            // Convert 50% token to ETH
            uint256 conversionPortion = SafeMath.div(
                SafeMath.mul(returnedTokens, 497),
                1000
            );
            ...
            uint256 ethBought = _token2Eth(_ToTokenContractAddress, conversionPortion);

            // Add Liquidity using left Tokens + ETH to Uniswap
            Iuniswap_Balancer_Unipool_Bridge_Zap_V1 UniSwapExchangeContractAddress = Iuniswap_Balancer_Unipool_Bridge_Zap_V1(
            ...
            uint256 max_tokens_ans = getMaxTokens(
                ...
                IERC20(_ToTokenContractAddress),
                ethBought
            );
        ...
        }   // if WETH exists in Pool
            else if (IBPool_Balancer_Unipool_Bridge_Zap_V1(_FromBalancerPoolAddress)
            ...
            // Convert WETH to ETH
            IWethToken_Balancer_Unipool_Bridge_Zap_V1(WethTokenAddress).withdraw(returnedTokens);
            // ETH to Uniswap Pool Liquidity
            LetsInvest(
                _ToTokenContractAddress,
                _toWhomToIssue,
                returnedTokens
            ...
            // Withdraw to Token with max liquidity
            address _FromTokenAddress = _getBestDeal(
                _FromBalancerPoolAddress
            );
            uint256 returnedTokens = _exitBalancer(
                _FromBalancerPoolAddress,
            ...
            uint256 ethBought = _token2Eth(_FromTokenAddress, returnedTokens);
            // Invest ETH to Uniswap
            LetsInvest(
                _ToTokenContractAddress,
                _toWhomToIssue,
                ethBought
    ...
    function _exitBalancer(
        ...
        require(
            IBPool_Balancer_Unipool_Bridge_Zap_V1(_FromBalancerPoolAddress).isBound(
                _ToTokenContractAddress
            ),
            "Token not bound"
        );

        returnedTokens = IBPool_Balancer_Unipool_Bridge_Zap_V1(_FromBalancerPoolAddress)
    ...
    function _toEther(
        ...
        uint256 returnedTokens = IBPool_Balancer_Unipool_Bridge_Zap_V1(
            _FromBalancerPoolAddress
        )
            .exitswapPoolAmountIn(WethTokenAddress, _amount, 1);
     ...
     */
    function _getBestDeal(address _FromBalancerPoolAddress)
        internal
        view
        returns (address _token)
    {
        ...
        //get token list
        address[] memory tokens = IBPool_Balancer_Unipool_Bridge_Zap_V1(
            _FromBalancerPoolAddress
        ).getFinalTokens();
        ...
        for (uint256 index = 0; index < tokens.length; index++) {
            ...
            IBPool_Balancer_Unipool_Bridge_Zap_V1 FromUniSwapExchangeContractAddress
            = IBPool_Balancer_Unipool_Bridge_Zap_V1(UniSwapFactoryAddress.getExchange(
                tokens[index]
            ));
    ...
    function _token2Eth(address _FromTokenContractAddress, uint256 _tokens2Trade)
        internal
        returns (uint256 ethBought)
    {

            Iuniswap_Balancer_Unipool_Bridge_Zap_V1 FromUniSwapExchangeContractAddress
         = Iuniswap_Balancer_Unipool_Bridge_Zap_V1(
    ...
    function LetsInvest(address _TokenContractAddress, address _towhomtoissue, uint256 _ethAmount)
        internal
        stopInEmergency
        returns (uint256)
    {
