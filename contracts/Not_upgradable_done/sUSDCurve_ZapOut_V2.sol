...
contract sUSDCurve_ZapOut_V2 is ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable DaiTokenAddress = address(
        0x6B175474E89094C44Da98b954EedeAC495271d0F
    );
    address public immutable UsdcTokenAddress = address(
        0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48
    );
    address public immutable UsdtTokenAddress = address(
        0xdAC17F958D2ee523a2206206994597C13D831ec7
    );
    address public immutable sUsdTokenAddress = address(
        0x57Ab1ec28D129707052df4dF418D58a2D46d5f51
    );
    address public immutable sUSDCurveExchangeAddress = address(
        0xA5407eAE9Ba41422680e2e00537571bcC53efBfD
    );
    address public immutable sUSDCurvePoolTokenAddress = address(
